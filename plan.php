...
<!-- //page details -->
<!-- //banner-botttom -->
    <section class="content-info py-5" ng-app="planApp" ng-controller="planCtrl">
      <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group search">
                            <label for="userid">Search Plan</label>
                            <!-- <span class="fa fa-search"></span> -->
                            <input class="form-control" type="text"  name="Name" id="userid" placeholder="Enter Plan/Category/Price/Final Price" ng-model="planSearch">
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
      <a href="plan_add.php" class="btn btn-danger btn-block"><span class="fa fa-plus"></span> Add New Plan</a>&nbsp;
    </div>
    </section>
    <!-- //banner-botttom -->
