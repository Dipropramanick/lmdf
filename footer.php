            ...
            <div class="container-fluid">
                <div class="row footer-top-inner-w3ls">
                    <div class="col-lg-4 col-md-6 footer-top ">
                        <h2>
                            <a href="index.php"><img src="images/logo.png" alt="" style="height:50px;"><img src="images/logo1.png" alt="" style="width:170px;"></a>
                        </h2>
                ...
                <!-- <p class="copy-right-grids text-li text-center my-sm-4 my-4">© 2019 Beardo. All Rights Reserved | Design by
