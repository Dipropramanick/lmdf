                        ...
                        <br>
                          ...
                          <div class="row">
                              <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                            <button ng-click="userEditClick()" class="btn submit btn-block" style="background-color:red;">Update Client</button>
                                      </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-lg-12">
                                            <button ng-click="userDelClick()" class="btn submit btn-block" style="background-color:red;">Delete Client</button>
                                      </div>
                                </div>
                </form>
            </div>
