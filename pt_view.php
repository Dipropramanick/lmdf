...
<div class="breadcrumb-agile">
	<ol class="breadcrumb mb-0">
		...
		<li class="breadcrumb-item active" aria-current="page">Personal Trainees</li>
	</ol>
</div>
<!-- //page details -->
<!-- //banner-botttom -->
    <section class="content-info py-5" ng-app="trainerApp" ng-controller="trainerCtrl">
      <div class="container">
      ...
      <div style="height:500px;overflow-y:scroll;">
        <table id="customers">
          ...
          <tr ng-repeat="usr in clientList | filter:usrSearch" style="cursor:pointer;" ng-click="traineeClick(usr)">
            <td >{{usr.id}}</td>
            <td>{{usr.name}}</td>
            <td>{{usr.phone}}</td>
          </tr>
