...
<!-- //page details -->
<!-- //banner-botttom -->
    <section class="content-info py-5" ng-app="planAddApp" ng-controller="planAddCtrl">
        <div class="container py-md-5">
            <div class="text-center px-lg-5">
                <h3 class="heading text-center mb-3 mb-sm-5">Add New Plan</h3>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group mx-auto mt-3">
                                            <button ng-click="planAddClick()" class="btn submit" style="background-color:red;">Add Plan</button>
                                        </div>
