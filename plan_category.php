...
<!-- //page details -->
<!-- //banner-botttom -->
    <section class="content-info py-5" ng-app="planCApp" ng-controller="planCCtrl">
      <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group search">
                            <label for="userid">Search Plan Categories</label>
                            <!-- <span class="fa fa-search"></span> -->
                            <input class="form-control" type="text"  name="Name" id="userid" placeholder="Enter Plan Category" ng-model="pcSearch">
                        </div>
                    </div>
                </div>
      ...
      <div style="height:300px;overflow-y:scroll;" class="container">
        <table id="customers">
          ...
          <tr ng-repeat="pc in pcList | filter:pcSearch" style="cursor:pointer;" ng-dblClick="pcClick(pc)">
            <td >{{pc.category}}</td>
          </tr>
</table>
</div>
    <div class="container">
      <a href="plan_category_add.php" class="btn btn-danger btn-block"><span class="fa fa-plus"></span> Add New Plan Category</a>&nbsp;
    </div>
    </section>
    <!-- //banner-botttom -->
