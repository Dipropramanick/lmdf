...
<head>
   ...
   <link href="//fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i" rel="stylesheet">
    ...
    <script type="text/javascript" src="js/employee_up_del.js"></script>
</head>
...
<div class="breadcrumb-agile">
	<ol class="breadcrumb mb-0">
		...
		<li class="breadcrumb-item active" aria-current="page">Update/Delete Employee</li>
	</ol>
</div>
<!-- //page details -->
<!-- //banner-botttom -->
    <section class="content-info py-5" ng-app="employeeAddApp" ng-controller="employeeAddCtrl">
        <div class="container py-md-5">
            <div class="text-center px-lg-5">
                <h3 class="heading text-center mb-3 mb-sm-5">Update/Delete Employee</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                              ...
                                              <div class="row">
                                                  <div class="col-lg-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label for="ftimein1">Time In</label>
                                                                <input type="time" id="ftimein1" placeholder="Enter time" ng-model="ftimein">
                                                            </div>
                                                          </div>
                                                          <div class="col-lg-6">
                                                              <div class="form-group">
                                                                  <label for="ftimeout1">Time Out</label>
                                                                  <input type="time" id="ftimeout1" placeholder="Enter time" ng-model="ftimeout">
                                                              </div>
                                                            </div>
                                                        </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label for="stimein1">Time In</label>
                                                                    <input type="time" id="stimein1" placeholder="Enter time" ng-model="stimein">
                                                                </div>
                                                              </div>
                                                              <div class="col-lg-6">
                                                                  <div class="form-group">
                                                                      <label for="stimeout1">Time Out</label>
                                                                      <input type="time" id="stimeout1" placeholder="Enter time" ng-model="stimeout">
                                                                  </div>
                                                                </div>
                                                            </div>
                                                          </div>
                                        ...
                                        <div class="row">
                                          <div class="col-lg-12">
                                            <button ng-click="employeeAddClick()" class="btn submit btn-block" style="background-color:red;">Update</button>
                                          </div>
                                        </div>
                                        ...
                                        <div class="row">
                                          <div class="col-lg-12">
                                            <button ng-click="employeeDelClick()" class="btn submit btn-block" style="background-color:red;">Delete</button>
                                          </div>
                                        </div>
