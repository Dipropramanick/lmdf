...
<div class="container">
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <input type="text" value="<?php echo $post_author;?>" id="fname" name="author">
    </div>
     
    <div class="form-group">
    <label for="post_category_id">Category Id</label>
    <input type="text" value="<?php echo $post_category_id;?>" id="fname" name="post_category_id">
    </div>
    
    <div class="form-group">
    <label for="post_status">Status</label>
    <input type="text" id="fname" value="<?php echo $post_status;?>" name="post_status">
    </div> 
     
     
    <div class="form-group">
    <!--<label for="post_image">Post Image</label>-->
    <img src = "images/<?php echo $post_image;?>" alt="" id="fname" name="image" width = "100">
    <input type="file" id="fname" name="image">
    </div>
     
    <div class="form-group">
    <label for="post_tags">Tags</label>
    <input type="text" id="fname" value="<?php echo $post_tags;?>" name="post_tags">
    </div> 
